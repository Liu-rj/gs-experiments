...
# python train_dgl.py --dataset=papers100m --device=cpu  --num-workers=2 --use-uva 
...
# python train_dgl.py --dataset=friendster --device=cuda --use-uva --sample-mode=ad-hoc
# python train_dgl.py --dataset=friendster --device=cuda --use-uva --sample-mode=matrix-fused
# python train_dgl.py --dataset=friendster --device=cuda --use-uva --sample-mode=matrix-nonfused
nsys profile -f true -o sage_fused_profile python train_minibatch.py --dataset=friendster --device=cuda --use-uva --sample-mode=matrix-fused --samples=10,10,10 --num-epoch=1
nsys profile -f true -o sage_nonfused_profile python train_minibatch.py --dataset=friendster --device=cuda --use-uva --sample-mode=matrix-nonfused --samples=10,10,10 --num-epoch=1
